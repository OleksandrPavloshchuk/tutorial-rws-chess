...
export default class LoginPage extends Component {
    ...
    onReset = event => {
        ...
        this.setState({login: "", password: "", errorMessage: undefined});
    }
    ...
    onSubmit = event => {
        ...
        this.props.app.mediatorClient.startSession(
                ...
                {
                    "LOGIN_ERROR": msg => {
                        this.setState({errorMessage: msg.text});
                    ...
                    "MOVE": msg => this.props.app.moveOther(msg.moveFrom, msg.moveTo, msg.piece,
